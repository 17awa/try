import{_ as n,c as a,b as e,o as l}from"./app-GjCcF8nQ.js";const p={};function i(t,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="选择菜单与多-label" tabindex="-1"><a class="header-anchor" href="#选择菜单与多-label"><span>选择菜单与多 Label</span></a></h1><div class="hint-container warning"><p class="hint-container-title">注意！！！</p><p>本文将假定您有一定的 Python 基础，因为本文涉及到变量，虽然也很简单，但我仍建议您在了解 Python 基础知识后再来完成本教程。</p></div><p>这一次我们所接触的东西可能会比较复杂，但它可以为你的 Mod 注入灵魂。</p><h2 id="选项菜单" tabindex="-1"><a class="header-anchor" href="#选项菜单"><span>选项菜单</span></a></h2><p>让我们先复习一下上节课学的脚本：</p><div class="language-rpy line-numbers-mode" data-highlighter="prismjs" data-ext="rpy" data-title="rpy"><pre><code><span class="line"><span class="token tag">label</span> ch1_start<span class="token punctuation">:</span></span>
